...
class Level:
    def __init__(self, window, name, menu_option):
        ...
        self.entity_list.extend(EntityFactory.get_entity('Level1Bg')) #esse puxa uma lista `extend`
        self.entity_list.append(EntityFactory.get_entity('Player1'))  # esse puxa um elemento `append`
